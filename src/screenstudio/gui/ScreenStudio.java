...
public class ScreenStudio extends javax.swing.JFrame {
    ...
    public void updateColumnsLayout() {
	    ...
	    tableSources.getColumnModel().getColumn(5).setHeaderValue(LANGUAGES.getString("WIDTH")); // NOI18N
            //Height
            tableSources.getColumnModel().getColumn(6).setResizable(false);
            tableSources.getColumnModel().getColumn(6).setPreferredWidth(75);
	    tableSources.getColumnModel().getColumn(6).setHeaderValue(LANGUAGES.getString("HEIGHT")); // NOI18N
            //Alpha
            tableSources.getColumnModel().getColumn(7).setResizable(false);
            tableSources.getColumnModel().getColumn(7).setPreferredWidth(75);
	    tableSources.getColumnModel().getColumn(7).setHeaderValue(LANGUAGES.getString("ALPHA")); // NOI18N
            //Start
    ...
    private void initComponents() {
        ...
        cboSourceViews.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Padrão", "Visualização 1", "Visualização 2", "Visualização 3", "Visualização 4" }));
        ...
        cboDefaultRecordingAction.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ocultar", "Minimizar", "Manter visível" }));
        ...
        lblThumbTitle.setText("Miniatura Título");

        txtThumbnailTitle.setText("ScreenStudio é Incrível!");
        ...
        tabs.addTab("Miniaturas", panThumbnail);
...
//        }
       ...
       // UIManager.put("MenuItem.selectionBackground", new ColorUIResource(new Color(255, 51, 0)));
        ...
        ScreenStudio screenStudio = new ScreenStudio();
        screenStudio.setLocationRelativeTo(null);
        screenStudio.setVisible(true);
...
//        });
    ...
    public void ScreenStudiosetLookAndfeel(){
     try{
        // hifi lookand feel 
