 ...
 * @author patrick
 */
public class ScreenStudio1 extends javax.swing.JFrame {
     ...
     */
    public ScreenStudio1() {
        ScreenStudiosetLookAndfeel();
        initComponents();

        this.setIconImage(new ImageIcon(ScreenStudio1.class.getResource("/screenstudio/gui/images/icon.png")).getImage());
        initControls();
        updateColumnsLayout();
        ...
        try {
            ...
            Logger.getLogger(ScreenStudio1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void mnuCaptureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuCaptureActionPerformed
        if (mFFMpeg != null) {
            ...
            if (trayIcon != null) {
                trayIcon.setImage(new ImageIcon(ScreenStudio1.class.getResource("/screenstudio/gui/images/iconStarting.png")).getImage());
            }
                ...
                new Thread(() -> {
                    ...
                    while (f != null) {
                        if (initState == FFMpeg.RunningState.Starting && f.getState() == FFMpeg.RunningState.Running) {
                            if (trayIcon != null) {
                                trayIcon.setImage(new ImageIcon(ScreenStudio1.class.getResource("/screenstudio/gui/images/iconRunning.png")).getImage());
                            }
...
//        }
       ...
       // UIManager.put("MenuItem.selectionBackground", new ColorUIResource(new Color(255, 51, 0)));
        ...
        ScreenStudio1 screenStudio = new ScreenStudio1();
